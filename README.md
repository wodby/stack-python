# Python stack for Wodby

Deploy Python on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Python stack in the Wodby catalog.
